      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-8">
            <p className="text-sm">
              <strong>Quick Summary:</strong> We collect information to provide and improve our services. We never sell your personal data. You have full control over your information and can request deletion at any time. We use industry-standard security to protect your data.
            </p>
          </div>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2">2.1 Information You Provide Directly</h3>
            <p>We collect information you provide when you:</p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li><strong>Create an Account:</strong> Username, email address, password, date of birth, country of residence</li>
              <li><strong>Complete Your Profile:</strong> Avatar, bio, gaming preferences, favorite genres, platform accounts (Steam ID, etc.)</li>
              <li><strong>Make Purchases:</strong> Billing name, billing address, payment method details (processed by secure third parties)</li>
              <li><strong>Contact Support:</strong> Name, email, description of issue, any attachments you provide</li>
              <li><strong>Participate in Community:</strong> Forum posts, reviews, ratings, comments, direct messages</li>
              <li><strong>Enter Promotions:</strong> Contact information, survey responses, competition entries</li>
              <li><strong>Subscribe to Newsletter:</strong> Email address, content preferences</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li><strong>Usage Data:</strong> Pages visited, time spent, click patterns, search queries, purchase history, wishlist items</li>
              <li><strong>Cookies and Tracking:</strong> Session cookies, persistent cookies, web beacons, pixel tags</li>
              <li><strong>Log Data:</strong> Access times, referring website addresses, browser language, crash reports</li>
              <li><strong>Location Information:</strong> Approximate location based on IP address for regional pricing and content</li>
              <li><strong>Game Activity:</strong> Games owned, playtime, achievements (when linked accounts permit)</li>
            </ul>

            <h3 className="text-xl font-semibold mb-2 mt-4">2.3 Information from Third Parties</h3>
            <p>We may receive information from:</p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li><strong>Social Media Platforms:</strong> When you log in using Facebook, Google, Twitter, Discord</li>
              <li><strong>Gaming Platforms:</strong> Steam, Epic Games, GOG (with your permission)</li>
              <li><strong>Payment Processors:</strong> Transaction confirmations, fraud prevention data</li>
              <li><strong>Analytics Providers:</strong> Demographic data, interest categories</li>
              <li><strong>Marketing Partners:</strong> Campaign effectiveness, referral sources</li>
              <li><strong>Public Databases:</strong> For age verification and fraud prevention</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">3.1 Service Provision and Improvement</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">3.2 Safety and Security</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">3.3 Communication and Marketing</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Send promotional emails about new products, sales, and events (with consent)</li>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">3.4 Legal and Compliance</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">3.5 Analytics and Research</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Payment processing (Stripe, PayPal, cryptocurrency processors)</li>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">4.2 Business Partners</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Game developers and publishers (for key activation and support)</li>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">4.6 Aggregated and Anonymized Data</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2">5.1 Types of Cookies We Use</h3>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li><strong>Functionality Cookies:</strong> Remember your preferences and personalization settings</li>
              <li><strong>Marketing Cookies:</strong> Track your activity to deliver relevant advertisements</li>
              <li><strong>Analytics Cookies:</strong> Collect anonymous data about site usage and performance</li>
              <li><strong>Social Media Cookies:</strong> Enable social media features and sharing</li>
            </ul>

            <h3 className="text-xl font-semibold mb-2 mt-4">5.2 Third-Party Cookies</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">5.3 Managing Cookies</h3>
            <p>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Third-party opt-out tools (e.g., Google Ad Settings, Facebook Ad Preferences)</li>
              <li>Industry opt-out platforms (e.g., NAI, DAA, EDAA)</li>
            </ul>

            <h3 className="text-xl font-semibold mb-2 mt-4">5.4 Do Not Track</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">6.1 Security Measures</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">6.2 Your Security Responsibilities</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">6.3 Data Breach Notification</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">7.1 Retention Periods</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong>Account Information:</strong> Duration of account plus 30 days after deletion</li>
              ...
              <li><strong>Marketing Communications:</strong> Until you unsubscribe plus 30 days</li>
              <li><strong>Cookie Data:</strong> Up to 13 months or until deleted</li>
              <li><strong>Server Logs:</strong> 90 days for security analysis</li>
              <li><strong>User Content:</strong> Until deleted by user or account termination</li>
            </ul>

            <h3 className="text-xl font-semibold mb-2 mt-4">7.2 Deletion Requests</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">8.1 Universal Rights</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">8.2 GDPR Rights (EU/EEA/UK Residents)</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">8.3 CCPA Rights (California Residents)</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">8.4 Additional State Rights</h3>
            <p>
              Residents of Virginia, Colorado, Connecticut, and Utah have similar rights under their respective privacy laws.
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">8.5 How to Exercise Your Rights</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">9.1 Transfer Mechanisms</h3>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">9.2 Data Localization</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">10.1 Age Verification</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">10.2 Parental Rights</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">10.3 Teen Privacy (13-17)</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">11.1 External Links</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">11.2 Integrated Services</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">11.3 User-Generated Links</h3>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">12. Marketing and Communications</h2>

            <h3 className="text-xl font-semibold mb-2">12.1 Marketing Preferences</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">12.2 Types of Communications</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li><strong>Transactional:</strong> Purchase confirmations, account updates (cannot opt-out)</li>
              <li><strong>Promotional:</strong> Sales, new products, events (opt-in/opt-out)</li>
              <li><strong>Newsletter:</strong> Weekly/monthly updates (opt-in/opt-out)</li>
              <li><strong>Recommendations:</strong> Personalized game suggestions (opt-in/opt-out)</li>
              <li><strong>Community:</strong> Forum replies, friend requests (customizable)</li>
            </ul>

            <h3 className="text-xl font-semibold mb-2 mt-4">12.3 Advertising</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">13.1 Contract Performance</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">13.2 Legitimate Interests</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">13.4 Legal Obligations</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">14.1 Types of Automated Decisions</h3>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">14.2 Your Rights</h3>
            <p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">15.1 Notification of Changes</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">15.2 Review Period</h3>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">17. Supervisory Authorities</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-2 mt-4">17.1 European Union</h3>
            <p>
              You can find your local Data Protection Authority at: <a href="https://edpb.europa.eu/about-edpb/board/members_en" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://edpb.europa.eu</a>
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">17.2 United Kingdom</h3>
            <p>
              Information Commissioner's Office (ICO): <a href="https://ico.org.uk" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://ico.org.uk</a>
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">17.3 California</h3>
            <p>
              California Privacy Protection Agency (CPPA): <a href="https://cppa.ca.gov" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://cppa.ca.gov</a>
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">18. Acknowledgment and Consent</h2>
            <p>
            ...
            <div className="mt-4 p-4 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg">
              ...
              <p className="text-sm mt-2">
                This Privacy Policy was last reviewed and updated on January 29, 2025.
              </p>
            </div>
          </section>
        </div>
