...
export function CollectionHeroV3({ bundle }: CollectionHeroV3Props) {
  ...
  return (
    <div className="container max-w-[1560px] relative min-h-[520px] w-full overflow-hidden rounded-3xl border border-border">
      ...
      <div className="relative z-20 flex flex-col justify-center px-6 pt-8 pb-20 lg:px-10 lg:py-10 lg:max-w-[55%] min-h-[520px] gap-5">
        ...
        {/* Title */}
        <h1
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight animate-fade-up"
        ...
        {hasVideo ? (
          ...
          >
            <button
              ...
              className="relative w-full max-w-sm aspect-video rounded-2xl overflow-hidden ring-1 ring-border shadow-2xl shadow-black/20 cursor-pointer group transition-transform duration-300 hover:-translate-y-0.5"
            >
              {videoThumbnail ? (
                <Image
                  src={videoThumbnail}
          ...
          <div
            className="relative max-w-sm pl-4 border-l-2 border-border animate-fade-up"
            style={{ animationDelay: "150ms" }}
          >
          ...
          <div
            className="flex items-center justify-center w-20 h-20 rounded-full bg-muted border border-border animate-fade-up"
            style={{ animationDelay: "150ms" }}
          >
            {bundle.type === BundleType.EBook ? (
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 px-6 lg:px-10 py-4 flex items-center justify-end pointer-events-none">
        <div
          className={`inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border shadow-lg animate-fade-up pointer-events-auto ${
            bundleHasEnded
