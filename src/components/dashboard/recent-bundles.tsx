...
import { KeyIcon, ChevronRightIcon, DamIcon as SteamIcon, PackageIcon } from 'lucide-react';
        ...
        <CardContent>
          ...
          >
            ...
            <p className="mb-6 max-w-md text-muted-foreground">
              Start your gaming journey by exploring our curated bundles. Every purchase supports amazing causes!
            </p>
            <Link href="/bundles">
              <Button className="bg-linear-to-r from-primary to-primary/90">Browse Bundles</Button>
            </Link>
          </motion.div>
        </CardContent>
      ) : (
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Purchased on {new Date(bundle.purchaseDate).toLocaleDateString()}
                </p>
              </div>
              <Button 
                variant="outline" 
